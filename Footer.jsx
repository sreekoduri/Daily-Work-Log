...
const Footer = ({ scrollToCategory }) => {
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between">
            ...
            <div className="w-40 mb-6 md:mb-0">
              ...
              <ul className="list-none space-y-2 relative z-50">
  <li>
    <Link to="/" className="block text-sm hover:underline text-left">
      Home
    </Link>
  </li>
  ...
  <li>
    <button
      type="button"
      onClick={handleCategoriesClick}
      className="block text-sm hover:underline text-left"
    >
      Products
    </button>
  </li>
  ...
  <li>
    <Link to="/cart" className="block text-sm hover:underline text-left">
      Cart
    </Link>
  </li>
              </ul>
            ...
            <div className="md:w-1/12 mb-6 md:mb-0 mr-8">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://youtube.com/@manakirana-o2g?si=Z4lQ7YP4YmtEQjxD"
                    target="_blank" rel="noopener noreferrer" className="text-emerald-800 hover:text-red-500">
